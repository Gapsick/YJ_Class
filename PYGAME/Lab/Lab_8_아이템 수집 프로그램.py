...
def create_items(num_items, size, screen_width, screen_height, obstacles):
    """주어진 수만큼 아이템을 생성하고, 장해물 및 다른 아이템과 겹치지 않도록 위치를 설정"""
    items = []
...
items = create_items(10, 10, screen_width, screen_height, obstacles)
...
while running:
    ...
    # 델타 타임 계산
    dt= clock.tick(60) / 1000.0  # ch eksdnlfh qusghksehls vmfpdlaekd tlrks
